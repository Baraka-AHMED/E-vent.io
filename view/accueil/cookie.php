<strong><h1> CONFIDENTIALITÉ ET COOKIES</h1></strong>

<div class="confidentialite">
  <strong><h2>Politique de confidentialité</h2></strong>

  <p>Le site web eeventio.alwaysdata.net est détenu par Eeventio, qui est un contrôleur de données de vos données personnelles.</p>

  <p>Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par eeventio.alwaysdata.net, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de eeventio.alwaysdata.net.</p>
  ...
  <p>Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à ekip13web@outlook.fr.</p>
</div>

<div class="cookies">

  <strong><h2> Cookies </h2></strong>

  <h4> ARTICLE 1 : ACCES AU SITE </h4>
  ...
  ·         par mail à l'adresse email ekip13web@outlook.fr
